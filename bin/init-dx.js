...
const filesToCreate = {
    ...
    "Divblox example package js": {"location": divbloxRoot+"divblox-packages-local/example-safe-to-delete/example-safe-to-delete.js",
                    "template": TEMPLATE_DIR+'/packages/example-safe-to-delete/example-safe-to-delete.js'},
    "Divblox example package end point": {"location": divbloxRoot+"divblox-packages-local/example-safe-to-delete/example-safe-to-delete-end-point.js",
                    "template": TEMPLATE_DIR+'/packages/example-safe-to-delete/example-safe-to-delete-end-point.js'},
