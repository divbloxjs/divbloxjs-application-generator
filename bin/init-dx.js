...
const filesToCreate = {
    ...
    "Divblox example package data model readme": {"location": divbloxRoot+"divblox-packages-local/example-safe-to-delete/data-model-readme.md",
                    "template": TEMPLATE_DIR+'/packages/example-safe-to-delete/data-model-readme.md'},
